...
bool blank() {
  ...
  if (rLeft == offTrack && rMid == offTrack && rRight == offTrack &&
      rMidLeft == offTrack && rMidRight == offTrack)
    return 1;
  else
    return 0;
}
...
*/
  ...
  // The midLeft and midRight sensors are used to increase the accuracy of the
  // run.
